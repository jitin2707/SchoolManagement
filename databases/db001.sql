...
-- Dumping data for table schoolmanagement.auth_permission: ~18 rows (approximately)
...
-- Dumping data for table schoolmanagement.auth_user: ~0 rows (approximately)
...
-- Dumping data for table schoolmanagement.django_admin_log: ~0 rows (approximately)
...
-- Dumping data for table schoolmanagement.django_content_type: ~6 rows (approximately)
...
-- Dumping data for table schoolmanagement.django_migrations: ~14 rows (approximately)
...
-- Dumping data for table schoolmanagement.django_session: ~0 rows (approximately)
