...
-- Dumping data for table test_db.django_migrations: ~31 rows (approximately)
...
-- Dumping data for table test_db.django_session: ~6 rows (approximately)
...
-- Dumping data for table test_db.myuser_loginrecords: ~18 rows (approximately)
...
-- Dumping data for table test_db.myuser_usersignup: ~9 rows (approximately)
